...
if __name__ == "__main__":
    ...
    csv_path = "/raid/hvtham/son/data/cls.csv"
    images_path = "/raid/hvtham/son/data/ENTRep_Private_Dataset"
    assemble(models = models, csv_path = csv_path, images_path = images_path)